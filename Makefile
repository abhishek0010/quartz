...
install-reform: ## Installs the utility, export GOPATH to PATH if not set
	go install github.com/abhishek0010/reform-vault@latest 

reform:
	reform-vault -input=$(VAULT_PATH) -output=content
